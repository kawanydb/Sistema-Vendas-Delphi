object frmRelCadProdutoComGrupoCategoria: TfrmRelCadProdutoComGrupoCategoria
    ...
    object BandaDoGrupo: TRLGroup
      ...
      object rlbnd5: TRLBand
        ...
        object rlbl10: TRLLabel
          ...
          Width = 206
          Height = 17
          Caption = 'M'#233'dia de Estoque por Categoria:'
          Font.Charset = ANSI_CHARSET
          Font.Color = clBlack
          Font.Height = -13
          Font.Name = 'Segoe UI'
        ...
        object rldbrsltQuantidade1: TRLDBResult
          Left = 623
          Top = 28
          Width = 92
          Height = 16
  ...
  object QryProdutos: TFDQuery
    ...
    object intgrfldQryProdutoscategoriaId: TIntegerField
      FieldName = 'categoriaId'
      Origin = 'categoriaId'
    end
    object strngfldQryProdutosDescricaoCategoria: TStringField
      FieldName = 'DescricaoCategoria'
      Origin = 'DescricaoCategoria'
      Size = 30
    end
  end
  object dtsProdutoss: TDataSource
    DataSet = QryProdutos
    Left = 312
    Top = 370
  end
