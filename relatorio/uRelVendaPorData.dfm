object frmRelVendaPorData: TfrmRelVendaPorData
  ...
  object QryVenda: TFDQuery
    ...
    object fdtncfldQryVendavendaId: TFDAutoIncField
      FieldName = 'vendaId'
      Origin = 'vendaId'
      ProviderFlags = [pfInWhere, pfInKey]
      ReadOnly = True
    end
    object intgrfldQryVendaclienteId: TIntegerField
      FieldName = 'clienteId'
      Origin = 'clienteId'
      Required = True
    end
    object strngfldQryVendanome: TStringField
      FieldName = 'nome'
      Origin = 'nome'
      Size = 60
    end
    object sqltmstmpfldQryVendadataVenda: TSQLTimeStampField
      FieldName = 'dataVenda'
      Origin = 'dataVenda'
    end
