...
type
  ...
  public
    ...
    destructor Destroy; override; // precisa destruir pra limpar a memória (ex:faxina antes de devolver um apê)
    //crud
...
{$REGION 'CRUD'}
function TCliente.Apagar: Boolean; //método apagar, da classe TCliente
var Qry:TFDQuery;
begin
