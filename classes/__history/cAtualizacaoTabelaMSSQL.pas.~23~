...
begin
//verifica se a tabela acaoAcesso existe, senão cria ela no banco
...
begin
  ...
  begin
    ExecutaDiretoBancoDeDados(
      ...
      ' CONSTRAINT FK_UsuariosAcaoAcessoUsuario '+
      ' FOREIGN KEY (usuarioId) REFERENCES usuarios(usuarioId), '+
      ' CONSTRAINT FK_UsuariosAcaoAcessoAcaoAcesso '+
