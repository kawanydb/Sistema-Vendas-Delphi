...
type
  TDTMGrafico = class(TDataModule)
    ...
    strngfldQry10ProdutosMaisVendidosLabel: TStringField;
    fmtbcdfldQry10ProdutosMaisVendidosValue: TFMTBCDField;
    QryVendasUltimaSemana: TFDQuery;
    sqltmstmpfldQryVendasUltimaSemanaLabel: TSQLTimeStampField;
    fmtbcdfldQryVendasUltimaSemanaValue: TFMTBCDField;
  private
