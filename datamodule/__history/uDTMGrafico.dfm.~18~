object DTMGrafico: TDTMGrafico
  ...
  object QryProdutoEstoque: TFDQuery
    ...
    object intgrfldQryProdutoEstoqueValue: TIntegerField
      FieldName = 'Value'
      Origin = 'Value'
    end
  end
  ...
  object Qry10ProdutosMaisVendidos: TFDQuery
    ...
    Left = 216
    Top = 88
    object strngfldQry10ProdutosMaisVendidosLabel: TStringField
      FieldName = 'Label'
      Origin = 'Label'
      ReadOnly = True
      Size = 91
    end
    object fmtbcdfldQry10ProdutosMaisVendidosValue: TFMTBCDField
      FieldName = 'Value'
      Origin = 'Value'
      ReadOnly = True
      Precision = 38
  ...
  object QryVendasUltimaSemana: TFDQuery
    ...
    Left = 120
    Top = 216
    object sqltmstmpfldQryVendasUltimaSemanaLabel: TSQLTimeStampField
      FieldName = 'Label'
      Origin = 'Label'
    end
    object fmtbcdfldQryVendasUltimaSemanaValue: TFMTBCDField
      FieldName = 'Value'
      Origin = 'Value'
      ReadOnly = True
      Precision = 38
