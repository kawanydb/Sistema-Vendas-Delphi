...
uses
  ...
  Vcl.ExtCtrls, Vcl.ComCtrls, uDtmConexao, cCadCategoria, uEnum;

type
  TfrmCadCategoria = class(TfrmTelaHeranca)
    fdtncfldQryListagemcategoriaId: TFDAutoIncField;
...
begin  // esse método vai identificar se ele vai alterar ou não na tela de herança
